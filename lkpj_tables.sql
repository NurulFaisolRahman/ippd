...
VALUES
(1, '35.12', 1, 2025, 1, 'Kabupaten Terinovatif - Innovative Government Award 2025', 'Pusat / Nasional', 'Kementerian Dalam Negeri', 'Kategori Kabupaten Terinovatif dalam IGA 2025', NOW(), NOW(), NULL),
(2, '35.12', 4, 2025, 2, 'Kabupaten Sehat Swasti Saba 2025 Kategori "Padapa"', 'Pusat / Nasional', 'Kementerian Kesehatan RI', 'Penghargaan Kabupaten/Kota Sehat Kategori Padapa', NOW(), NOW(), NULL),
(3, '35.12', 1, 2025, 3, 'CNN INDONESIA AWARD 2025 Kategori “Outstanding Regional Initiative For MSME Empowerment”', 'Pusat / Nasional', 'CNN', 'Inisiatif pemberdayaan UMKM daerah', NOW(), NOW(), NULL),
(4, '35.12', 1, 2025, 4, 'Opini LKPD/OPINI BPK atas LKPD', 'Pusat / Nasional', 'BPK RI', 'Opini Wajar Tanpa Pengecualian (WTP)', NOW(), NOW(), NULL),
(5, '35.12', 1, 2025, 5, 'Penghargaan Atas Capaian Perolehan Pajak Tertinggi Secara Nasional', 'Pusat / Nasional', 'Kantor Pelayanan Pajak Pratama Situbondo', 'Capaian perolehan pajak tertinggi', NOW(), NOW(), NULL),
(6, '35.12', 4, 2025, 6, 'Kabupaten/Kota Sehat (Swasti Saba) Kategori Padapa', 'Pusat / Nasional', 'Kementerian Kesehatan Republik Indonesia (Kemenkes RI)', 'Swasti Saba Kategori Padapa', NOW(), NOW(), NULL),
(7, '35.12', 5, 2025, 7, 'KABUPATEN LAYAK ANAK Kategori “Nindya”', 'Pusat / Nasional', 'Kementerian Pemberdayaan Perempuan dan Perlindungan Anak Republik Indonesia', 'KLA Kategori Nindya', NOW(), NOW(), NULL),
(8, '35.12', 1, 2025, 8, 'KOMPAS TV AWARD Kategori “Daerah Peduli Pengembangan UMKM dan Potensi Sumber Daya Lokal”', 'Pusat / Nasional', 'KOMPAS TV', 'Penghargaan daerah peduli UMKM dan potensi lokal', NOW(), NOW(), NULL),
(9, '35.12', 1, 2025, 9, 'Anugerah TIMES Indonesia 2025 kategori “The Gateway Leader Award bidang Accelerating Regional Economic Advancement”', 'Pusat / Nasional', 'Times Indonesia', 'The Gateway Leader Award', NOW(), NOW(), NULL),
(10, '35.12', 6, 2025, 10, 'TERBAIK 1 PETUGAS IB BERPRESTASI PROVINSI JAWA TIMUR KATEGORI AKSEPTOR TINGGI TAHUN 2025', 'Provinsi', 'Pemerintah Provinsi Jawa Timur', 'Kategori Akseptor Tinggi Tingkat Provinsi Jatim', NOW(), NOW(), NULL),
(11, '35.12', 6, 2025, 11, 'PERINGKAT 2 KABUPATEN DENGAN CAKUPAN VAKSINASI PMK TERBAIK TINGKAT PROVINSI', 'Provinsi', 'KETUA SATGAS PENANGANAN PMK PROVINSI JAWA TIMUR', 'Cakupan Vaksinasi PMK Terbaik Tingkat Jatim', NOW(), NOW(), NULL),
