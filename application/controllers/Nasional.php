...
class Nasional extends CI_Controller {
  ...
  public function DeleteKementerian() {
    ...
    $this->load->view('Nasional/header', $Header);
    $this->load->view('Nasional/IsuStrategis', $Data);
}
...
public function DeleteIsuStrategis() {
   ...
   public function SPM() {
        ...
        $this->load->view('Nasional/header', $Header);
        $this->load->view('Nasional/SPM', $Data);
    }
    ...
    public function ProyekStrategis() {
        ...
        $this->load->view('Nasional/header', $Header);
        $this->load->view('Nasional/ProyekStrategis', $Data);
    }
...
public function ProgramStrategis() {
        ...
        $this->load->view('Nasional/header', $Header);
        $this->load->view('Nasional/ProgramStrategis', $Data);
    }
   ...
   public function PermasalahanPokok() {
    ...
    $this->load->view('Nasional/header', $Header);
    $this->load->view('Nasional/PermasalahanPokok', $Data);
}
...
public function DeletePermasalahanPokok() {
  ...
  public function IsuKLHS() {
    ...
    $this->load->view('Nasional/header', $Header);
    $this->load->view('Nasional/IsuKLHS', $Data);
}
...
public function IsuGlobal() {
    ...
    $this->load->view('Nasional/header', $Header);
    $this->load->view('Nasional/IsuGlobal', $Data);
}
...
public function IsuNasional() {
    ...
    $this->load->view('Nasional/header', $Header);
    $this->load->view('Nasional/IsuNasional', $Data);
}
