                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 60%;">Sasaran Pembangunan</th>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#Input").click(function() {
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/InputSasaranPembangunan", SasaranPembangunan).done(function(Respon) {
                        if (Respon == '1') {
            ...
            $("#Edit").click(function() {
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/EditSasaranPembangunan", SasaranPembangunan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Nasional/SasaranPembangunanRPJMN"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Nasional/HapusSasaranPembangunan", SasaranPembangunan).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Nasional/SasaranPembangunanRPJMN"
                    } else {
                        alert(Respon)
