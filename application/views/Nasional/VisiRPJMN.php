                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <div class="button-icon-btn sm-res-mg-t-30">
                                <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#ModalInputVisi"><i class="notika-icon notika-edit"></i> <b>Input Visi RPJMN</b></button>
                            </div>
                        </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 70%;">Visi RPJMN</th>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="Visi" placeholder="Input Visi RPJMN"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="_Visi" placeholder="Input Visi RPJMN"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#Input").click(function() {
                if (isNaN($("#TahunMulai").val()) || $("#TahunMulai").val() == "" || $("#TahunMulai").val().length != 4) {
                    ...
                    $.post(BaseURL+"Super/InputVisiRPJMN", Visi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/VisiRPJMN"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $("#Edit").click(function() {
                if (isNaN($("#_TahunMulai").val()) || $("#_TahunMulai").val() == "" || $("#_TahunMulai").val().length != 4) {
                    ...
                    $.post(BaseURL+"Super/EditVisiRPJMN", Visi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/VisiRPJMN"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Super/HapusVisiRPJMN", Visi).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Super/VisiRPJMN"
                    } else {
                        alert(Respon)
