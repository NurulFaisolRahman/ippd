                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="Tahapan" rows="3" style="resize: vertical;" placeholder="Uraian Tahapan RPJMN"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="_Tahapan" rows="3" style="resize: vertical;" placeholder="Uraian Tahapan RPJMN"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="ModalInputSubTahapan" role="dialog">
    <div class="modal-dialog modals-default">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h2>Tambah Sub Tahapan RPJMN</h2>
            </div>
            <div class="modal-body" style="padding-top: 20px;">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="SubTahapan" rows="3" style="resize: vertical;" placeholder="Uraian Sub Tahapan RPJMN"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="_SubTahapan" rows="3" style="resize: vertical;" placeholder="Uraian Sub Tahapan RPJMN"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#hierarki-table tbody').on('click', '.HapusTahapan', function () {
            if(confirm("Yakin ingin menghapus Tahapan ini? Seluruh sub-data dibawahnya mungkin akan ikut terhapus.")) {
                ...
                $.post(BaseURL+"Nasional/HapusTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })
            }
        });
        ...
        // ==============================================
        // SCRIPT SUB TAHAPAN RPJMN (LEVEL 2)
        // ==============================================
        $("#SimpanSubTahapan").click(function() {
            if ($("#SubTahapan").val() == "") {
                ...
                $.post(BaseURL+"Nasional/InputSubTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })                         
            }
        });
        ...
        $("#EditBtnSubTahapan").click(function() {
            if ($("#_SubTahapan").val() == "") {
                ...
                $.post(BaseURL+"Nasional/EditSubTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })                         
            }
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusSubTahapan', function () {
            if(confirm("Yakin ingin menghapus Sub Tahapan ini? Seluruh sub-data dibawahnya mungkin akan ikut terhapus.")) {
                var Data = { Id: $(this).data('id') }
                $.post(BaseURL+"Nasional/HapusSubTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })
            }
        });
        ...
        $("#SimpanPembangunan").click(function() {
            if ($("#TahapanPembangunan").val() == "") {
                ...
                $.post(BaseURL+"Nasional/InputPembangunanTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })                         
            }
        });
        ...
        $("#EditBtnPembangunan").click(function() {
            if ($("#_TahapanPembangunan").val() == "") {
                ...
                $.post(BaseURL+"Nasional/EditPembangunanTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })                         
            }
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusPembangunan', function () {
            if(confirm("Yakin ingin menghapus Tahapan Pembangunan ini?")) {
                var Data = { Id: $(this).data('id') }
                $.post(BaseURL+"Nasional/HapusPembangunanTahapanRPJMN", Data).done(function(Respon) {
                    if (Respon == '1') { window.location.reload(); } else { alert(Respon) }
                })
            }
        });
