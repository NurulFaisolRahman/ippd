                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <div class="button-icon-btn sm-res-mg-t-30">
                                <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#ModalInputTahapan"><i class="notika-icon notika-edit"></i> <b>Input Tahapan RPJPN</b></button>
                            </div>
                        </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 70%;">Tahapan RPJPN</th>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 9px;">
                                        <div class="col-lg-2">
                                            <label class="hrzn-fm"><b>Tahapan RPJPN</b></label>
                                        </div>
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="Tahapan" placeholder="Input Tahapan RPJPN"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 9px;">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="_Tahapan" placeholder="Input Tahapan RPJPN"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#Periode").change(function(){
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/GetVisiRPJPN", {Id : $("#Periode").val()}).done(function(Respon) {
            ...
            $("#_Periode").change(function(){
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/GetVisiRPJPN", {Id : $("#_Periode").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Visi = ''
                        for (let i = 0; i < Data.length; i++) {
                            Visi += '<option value="'+Data[i].Id+'">'+Data[i].Visi+'</option>'
            ...
            $("#Input").click(function() {
                if ($("#Periode").val() == "") {
                    ...
                    var Tahapan = { _Id   : $("#IdVisi").val(),
                                 Tahapan   : $("#Tahapan").val() }
                    $.post(BaseURL+"Nasional/InputTahapanRPJPN", Tahapan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Nasional/TahapanRPJPN"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $("#Edit").click(function() {
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/EditTahapanRPJPN", Tahapan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Nasional/TahapanRPJPN"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Nasional/HapusTahapanRPJPN", Tahapan).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Nasional/TahapanRPJPN"
                    } else {
                        alert(Respon)
