            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="data-table-list">
                    <div class="basic-tb-hd" style="margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                        <h3 style="margin: 0; color: #333; font-weight: 600; line-height: 1.5;">Sasaran Prioritas Nasional RKP</h3>
...
<script>
    ...
    function saveExpandedState() {
        ...
        sessionStorage.setItem('expandedRowsSasaranPrioritasRKP', JSON.stringify(expanded)); 
    }
    ...
    $(document).ready(function() {
        ...
        var expandedRows = JSON.parse(sessionStorage.getItem('expandedRowsSasaranPrioritasRKP')) || [];
        ...
        $("#SimpanPN").click(function() {
            if ($("#IdVisiPN").val() == "") alert('Pilih Periode RPJMN!');
                ...
                $.post(BaseURL+"Nasional/InputRKP_PN", { _IdVisi: $("#IdVisiPN").val(), PrioritasNasional: $("#PrioritasNasional").val() }).done(function(Respon) {
        ...
        $("#EditBtnPN").click(function() {
            $.post(BaseURL+"Nasional/EditRKP_PN", { Id: $("#IdPNForm").val(), _IdVisi: $("#_IdVisiPN").val(), PrioritasNasional: $("#_PrioritasNasional").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusPN', function () {
            if(confirm("Yakin hapus Prioritas Nasional ini? Sub-data dibawahnya akan hilang.")) {
                $.post(BaseURL+"Nasional/HapusRKP_PN", { Id: $(this).data('id') }).done(function(Respon) {
                    if(Respon=='1') window.location.reload(); else alert(Respon);
                });
            }
        });
        ...
        $("#SimpanPP").click(function() {
            $.post(BaseURL+"Nasional/InputRKP_PP", { _IdPN: $("#IdPNParent").val(), ProgramPrioritas: $("#ProgramPrioritas").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $("#EditBtnPP").click(function() {
            $.post(BaseURL+"Nasional/EditRKP_PP", { Id: $("#IdPPForm").val(), _IdPN: $("#_IdPNParent").val(), ProgramPrioritas: $("#_ProgramPrioritas").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusPP', function () {
            if(confirm("Yakin hapus Program Prioritas ini?")) {
                $.post(BaseURL+"Nasional/HapusRKP_PP", { Id: $(this).data('id') }).done(function(Respon) {
                    if(Respon=='1') window.location.reload(); else alert(Respon);
                });
            }
        });
        ...
        $("#SimpanKP").click(function() {
            $.post(BaseURL+"Nasional/InputRKP_KP", { _IdPP: $("#IdPPParent").val(), KegiatanPrioritas: $("#KegiatanPrioritas").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $("#EditBtnKP").click(function() {
            $.post(BaseURL+"Nasional/EditRKP_KP", { Id: $("#IdKPForm").val(), _IdPP: $("#_IdPPParent").val(), KegiatanPrioritas: $("#_KegiatanPrioritas").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusKP', function () {
            if(confirm("Yakin hapus Kegiatan Prioritas ini?")) {
                $.post(BaseURL+"Nasional/HapusRKP_KP", { Id: $(this).data('id') }).done(function(Respon) {
                    if(Respon=='1') window.location.reload(); else alert(Respon);
                });
            }
        });
        ...
        $("#SimpanProyek").click(function() {
            $.post(BaseURL+"Nasional/InputRKP_Proyek", { _IdKP: $("#IdKPParent").val(), ProyekPrioritas: $("#ProyekPrioritas").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $("#EditBtnProyek").click(function() {
            $.post(BaseURL+"Nasional/EditRKP_Proyek", { Id: $("#IdProyekForm").val(), _IdKP: $("#_IdKPParent").val(), ProyekPrioritas: $("#_ProyekPrioritas").val() }).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusProyek', function () {
            if(confirm("Yakin hapus Proyek Prioritas ini?")) {
                $.post(BaseURL+"Nasional/HapusRKP_Proyek", { Id: $(this).data('id') }).done(function(Respon) {
                    if(Respon=='1') window.location.reload(); else alert(Respon);
                });
            }
        });
        ...
        $("#SimpanSasaran").click(function() {
            ...
            $.post(BaseURL+"Nasional/InputRKP_Sasaran" + tipe, Data).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $("#EditBtnSasaran").click(function() {
            ...
            $.post(BaseURL+"Nasional/EditRKP_Sasaran" + tipe, Data).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusSasaran', function () {
            if(confirm("Yakin hapus Sasaran ini? Indikator didalamnya juga akan hilang.")) {
                ...
                $.post(BaseURL+"Nasional/HapusRKP_Sasaran" + tipe, { Id: $(this).data('id') }).done(function(Respon) {
                    if(Respon=='1') window.location.reload(); else alert(Respon);
                });
            }
        });
        ...
        $("#SimpanIndikator").click(function() {
            ...
            $.post(BaseURL+"Nasional/InputRKP_Indikator" + tipe, Data).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $("#EditBtnIndikator").click(function() {
            ...
            $.post(BaseURL+"Nasional/EditRKP_Indikator" + tipe, Data).done(function(Respon) {
                if(Respon=='1') window.location.reload(); else alert(Respon);
            });
        });
        ...
        $('#hierarki-table tbody').on('click', '.HapusIndikator', function () {
            if(confirm("Yakin hapus Indikator ini?")) {
                var tipe = $(this).data('tipe');
                $.post(BaseURL+"Nasional/HapusRKP_Indikator" + tipe, { Id: $(this).data('id') }).done(function(Respon) {
                    if(Respon=='1') window.location.reload(); else alert(Respon);
                });
            }
        });
