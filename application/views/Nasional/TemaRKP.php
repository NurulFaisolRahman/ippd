                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <div class="button-icon-btn sm-res-mg-t-30">
                                <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#ModalInputTemaRKP"><i class="notika-icon notika-edit"></i> <b>Input Tema RKP</b></button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <?php $No = 1; foreach ($TemaRKP as $key) { ?>
                                    <tr>
                                        <td style="vertical-align: middle;" class="text-center"><?=$No++?></td>
                                        <td style="vertical-align: middle;"><?=$key['TemaRKP']?></td>
                                        <td style="vertical-align: middle;"><?=$key['Tahun']?></td>
                                        <?php if (isset($_SESSION['Level']) && $_SESSION['Level'] == 0) { ?>
                                        <td class="text-center" style="vertical-align: middle;">
                                            <button class="btn btn-sm btn-amber amber-icon-notika btn-reco-mg btn-button-mg Edit" Edit="<?=$key['Id'].'|'.$key['TemaRKP'].'|'.$key['Tahun']?>"><i class="notika-icon notika-edit"></i></button>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row" style="margin-top: 9px;">
                                        <div class="col-lg-2">
                                            <label class="hrzn-fm"><b>Tema RKP</b></label>
                                        </div>
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" id="TemaRKP" placeholder="Input Tema RKP">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 9px;">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" id="Tahun" placeholder="Input Tahun">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row" style="margin-top: 9px;">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                ...
                                                <input type="text" class="form-control input-sm" id="_TemaRKP" placeholder="Input Tema RKP">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 9px;">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" id="_Tahun" placeholder="Input Tahun">
                                            </div>
                                        </div>
                                    </div>
                                </div>
