            ...
            $("#Input").click(function() {
                if ($("#Periode").val() == "") {
                    ...
                    var Misi = { _Id   : $("#IdVisi").val(),
                                 Misi   : $("#Misi").val() }
                    $.post(BaseURL+"Super/InputMisiRPJPN", Misi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/MisiRPJPN"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $("#Edit").click(function() {
                if ($("#_Periode").val() == "") {
                    ...
                    var Misi = { Id   : $("#Id").val(),
                                 _Id   : $("#_IdVisi").val(),
                                 Misi   : $("#_Misi").val() }
                    $.post(BaseURL+"Super/EditMisiRPJPN", Misi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/MisiRPJPN"
                        } else {
                            alert(Respon)
