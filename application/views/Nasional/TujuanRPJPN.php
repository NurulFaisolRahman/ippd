                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <div class="button-icon-btn sm-res-mg-t-30">
                                <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#ModalInputTujuan"><i class="notika-icon notika-edit"></i> <b>Input Tujuan RPJPN</b></button>
                            </div>
                        </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 70%;">Tujuan RPJPN</th>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 9px;">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="Tujuan" placeholder="Input Tujuan RPJPN"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 9px;">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="_Tujuan" placeholder="Input Tujuan RPJPN"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#Periode").change(function(){
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Super/GetMisiRPJPN", {Id : $("#Periode").val()}).done(function(Respon) {
            ...
            $("#_Periode").change(function(){
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Super/GetMisiRPJPN", {Id : $("#_Periode").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Misi = ''
                        for (let i = 0; i < Data.length; i++) {
                            Misi += '<option value="'+Data[i].Id+'">'+Data[i].Misi+'</option>'
            ...
            $("#Input").click(function() {
                if ($("#Periode").val() == "") {
                    ...
                    var Tujuan = { _Id      : $("#IdMisi").val(),
                                   Tujuan   : $("#Tujuan").val() }
                    $.post(BaseURL+"Super/InputTujuanRPJPN", Tujuan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/TujuanRPJPN"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $("#Edit").click(function() {
                if ($("#_Periode").val() == "") {
                    ...
                    var Tujuan = { Id       : $("#Id").val(),
                                   _Id      : $("#_IdMisi").val(),
                                   Tujuan   : $("#_Tujuan").val() }
                    $.post(BaseURL+"Super/EditTujuanRPJPN", Tujuan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/TujuanRPJPN"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Super/HapusTujuanRPJPN", Tujuan).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Super/TujuanRPJPN"
                    } else {
                        alert(Respon)
