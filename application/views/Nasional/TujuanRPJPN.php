        ...
        jQuery(document).ready(function($) {
            ...
            $("#Periode").change(function(){
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/GetMisiRPJPN", {Id : $("#Periode").val()}).done(function(Respon) {
            ...
            $("#_Periode").change(function(){
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/GetMisiRPJPN", {Id : $("#_Periode").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Misi = ''
                        for (let i = 0; i < Data.length; i++) {
                            Misi += '<option value="'+Data[i].Id+'">'+Data[i].Misi+'</option>'
            ...
            $("#Input").click(function() {
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Nasional/InputTujuanRPJPN", Tujuan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Nasional/TujuanRPJPN"
                        } else {
                            alert(Respon)
                        }
                    })                         
