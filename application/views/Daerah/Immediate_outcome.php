          ...
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select id="pelaksana_urutan_l4" class="form-control">
...
$(document).ready(function() {
  ...
  $('#modalLevel4').on('show.bs.modal', function(e){
    ...
    if (!$(e.relatedTarget).hasClass('btn-edit-level4')) {
      ...
      $('#taktikal_id').val('');
      $('#kinerja_level4').val('');
      $('#pelaksana_urutan_l4').val('Sedang');
  ...
  $(document).on('click', '.btn-edit-level4', function(){
    ...
    $('#pelaksana_urutan_l4').val(pelaksana);
  ...
  $('#btn-simpan-level4').click(function() {
    ...
    $.post(BaseURL + 'Daerah/Immediate_outcome_simpan', {
      ...
      kinerja: kinerja,
      indikator: indikator,
      pelaksana_urutan: $('#pelaksana_urutan_l4').val(),
  ...
  // ================= FILTER WILAYAH (sama dengan Level 2 & 3) =================
