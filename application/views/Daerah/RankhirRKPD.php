...
<head>
    ...
    <style>
        ...
        /* ===== STYLE UTAMA ===== */
        .table-rankhir th, .table-rankhir td { 
        ...
        .table-rankhir .uraian { 
            text-align: left !important; 
            padding-left: 10px !important; 
        }
        .table-rankhir .rp { white-space: nowrap; font-weight: 500; text-align: right; }
        ...
        /* ===== FILTER ===== */
        #FilterInstansiGroupBefore {
            transition: all 0.3s ease;
        }
        
        #FilterInstansiGroupBefore label {
            font-weight: 600;
        }
        
        #FilterInstansiBeforeLogin {
            width: 100%;
        }
                ...
                <div class="col-lg-12">
                    <div class="data-table-list">
                                                    ...
                                                    <div class="filter-group">
                                                        ...
                                                        <select class="form-control filter-select" id="FilterInstansi">
                                                            ...
                                                            <?php foreach ($ListInstansi as $ins) { ?>
                                                                <option value="<?= $ins['id'] ?>" <?= ($this->input->get('instansi_id') == $ins['id']) ? 'selected' : '' ?>>
                        ...
                        <div class="basic-tb-hd">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2><i class="fa fa-file-text"></i> Rankhir RKPD</h2>
                                    <p class="text-muted">
                                        <i class="fa fa-info-circle"></i> 
                                        Data Rankhir RKPD diambil dari menu <strong>Rancangan Akhir Renja Perangkat Daerah</strong>.
                                        <span class="badge-rankhir">
                                            <i class="fa fa-flag-checkered"></i> Rankhir RKPD
                                        </span>
                                    </p>
                                </div>
                            </div>
                        ...
                        <!-- SOURCE DATA INFO                                            -->
                        <!-- ============================================================ -->
                        <?php if (!empty($RankhirData)) { ?>
                            <div class="source-data-info">
                                <i class="fa fa-info-circle"></i> 
                                <strong>Data Rankhir RKPD:</strong> Data ini adalah hasil sinkronisasi dari Rancangan Akhir Renja PD.
                        ...
                        <!-- ============================================================ -->
                        <!-- TABEL RANKHIR RKPD (HANYA TOMBOL EDIT)                      -->
                        <!-- ============================================================ -->
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped table-rankhir">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php if (!empty($RankhirData)) { ?>
                                        <?php foreach ($RankhirData as $row) { ?>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                        <tr class="row-indikator-detail" data-detail-id="<?= $detail['id'] ?>">
                                                                            ...
                                                                            <?php if (!empty($KodeWilayah) && isset($_SESSION['Level']) && $_SESSION['Level'] == 3) { ?>
                                                                            <td class="text-center" style="white-space: nowrap; min-width: 70px;">
                                                                                <div class="btn-group-aksi">
                                                                                    <button class="btn btn-warning btn-xs BtnEditRankhir"
                                                                                        data-id="<?= $detail['id'] ?>"
                                                                                        data-header-id="<?= $row['id'] ?>"
                                                                                        title="Edit Data Rankhir"
                                                                                        type="button">
                                                                                        <i class="notika-icon notika-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-xs BtnHapusRankhir"
                                                                                        data-id="<?= $detail['id'] ?>"
                                                                                        data-header-id="<?= $row['id'] ?>"
                                                                                        data-indikator="<?= html_escape(substr($detail['indikator_kinerja'] ?? '-', 0, 50)) ?>"
                                                                                        title="Hapus Data Rankhir"
                                                                                        type="button">
                                    ...
                                    <?php } else { ?>
                                        <tr>
                                            <td colspan="6" class="text-center no-data">
                                                <i>Belum ada data Rankhir RKPD</i>
                                                <br>
                                                <small class="text-muted">
                                                    Data akan otomatis muncul saat Instansi membuat Rancangan Akhir Renja.
                                                </small>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
<!-- ============================================================ -->
<!-- MODAL EDIT RANKHIR RKPD (DAERAH) - DENGAN JABATAN            -->
<!-- ============================================================ -->
<div class="modal fade" id="ModalEditRankhir" role="dialog" style="z-index: 999999 !important;">
    <div class="modal-dialog modal-lg" style="position: relative; margin: 30px auto !important; max-width: 900px;">
        <div class="modal-content" style="max-height: 100vh; overflow: hidden; border-radius: 8px; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
            <div class="modal-header" style="flex-shrink: 0; background: #f8f9fa; border-bottom: 2px solid #dee2e6; border-radius: 8px 8px 0 0;">
                ...
                <h4><b><i class="fa fa-edit" style="color: #ffc107;"></i> Edit Rankhir RKPD</b></h4>
                ...
                <div class="alert alert-warning" style="margin-top: 10px; padding: 8px 12px; font-size: 12px;">
                    <i class="fa fa-info-circle"></i> 
                    Perubahan akan ditandai dan muncul sebagai notifikasi di menu Rancangan Akhir Renja Perangkat Daerah.
                </div>
            </div>
            ...
            <div class="modal-footer" style="flex-shrink: 0; border-top: 1px solid #e5e5e5; padding: 10px 20px; background: #fafafa; border-radius: 0 0 8px 8px;">
                ...
                <button class="btn btn-warning" id="BtnSimpanEditRankhir"><b><i class="fa fa-save"></i> SIMPAN PERUBAHAN</b></button>
            </div>
        </div>
    </div>
</div>
...
function loadEditProvinsi(selectedKode) {
    ...
    $.ajax({
        url: BaseURL + "Daerah/GetListProvinsi",
        type: "GET",
        dataType: "json",
    ...
    $("#Filter").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res === '1' || res === 1) {
                    var redirectUrl = BaseURL + "Daerah/RankhirRKPD";
...
<?php if (isset($_SESSION['KodeWilayah']) && (!isset($_SESSION['Level']) || $_SESSION['Level'] != 4)) { ?>
    <?php if (!empty($ListInstansi)) { ?>
        $("#FilterInstansiBtn").click(function() {
            var instansiId = $("#FilterInstansi").val();
            var url = BaseURL + "Daerah/RankhirRKPD";
            if (instansiId && instansiId != '') { url += "?instansi_id=" + instansiId; }
            window.location.href = url;
        });
        $("#ResetFilterBtn").click(function() { 
            window.location.href = BaseURL + "Daerah/RankhirRKPD"; 
        });
    <?php } ?>
<?php } ?>
...
function initEditSelect2(selector, placeholder = 'Pilih...') {
    ...
    $(selector).select2({
        ...
        dropdownParent: $('#ModalEditRankhir'),
        width: '100%',
        allowClear: true
    });
}
...
function loadEditBidangPengampuOptions(selectedId = '') {
    ...
    $.ajax({
        url: BaseURL + 'Daerah/getDaftarDinasRenja',
        type: 'GET',
        dataType: 'json',
        beforeSend: function() {
...
// ================================================================
// 2. LOAD PENGAMPU BERDASARKAN BIDANG YANG DIPILIH (CASCADING)
// ================================================================
function loadEditPengampuByBidang(dinasId, selectedPelaksanaId = '') {
    ...
    $.ajax({
        url: BaseURL + 'Daerah/getPelaksanaByDinasRenja',
        type: 'POST',
        data: { 
            dinas_id: dinasId,
            [CSRF_NAME]: CSRF_TOKEN 
        ...
        success: function(data) {
            ...
            if (data && data.length > 0) {
                ...
                options += '<option value="" disabled>Tidak ada pelaksana untuk bidang ini</option>';
            }
...
// ================================================================
// EVENT CHANGE BIDANG PENGAMPU -> LOAD PENGAMPU
// ================================================================
...
// MODAL SHOWN EVENTS
// ================================================================
$('#ModalEditRankhir').on('shown.bs.modal', function() {
...
$('#ModalEditRankhir').on('hidden.bs.modal', function() {
    if ($('#EditBidangPengampu').hasClass('select2-hidden-accessible')) {
        $('#EditBidangPengampu').select2('destroy');
    }
    if ($('#EditPengampu').hasClass('select2-hidden-accessible')) {
...
// ================================================================
// TOMBOL EDIT RANKHIR RKPD
// ================================================================
$(document).off('click', '.BtnEditRankhir').on('click', '.BtnEditRankhir', function(e) {
    e.preventDefault();
    var id = $(this).data('id');
    ...
    $.ajax({
        url: BaseURL + "Daerah/GetRankhirRKPDDetail",
        type: "POST",
        data: {
            id: id,
            [CSRF_NAME]: CSRF_TOKEN
            ...
            if (res.status === "success" && res.data) {
                ...
                if (d.lokasi) {
                    if (d.lokasi.indexOf('manual_') === 0) {
                        ...
                        $.ajax({
                            url: BaseURL + "Daerah/getLokasiDetail",
                            type: "POST",
...
// ================================================================
// TOMBOL SIMPAN EDIT RANKHIR RKPD
// ================================================================
$(document).off('click', '#BtnSimpanEditRankhir').on('click', '#BtnSimpanEditRankhir', function(e) {
    e.preventDefault();
    ...
    if (!confirm("Anda akan mengubah data Rankhir RKPD.\n\nPerubahan akan ditandai dan muncul sebagai notifikasi di menu Rancangan Akhir Renja Perangkat Daerah.\n\nLanjutkan?")) {
        return;
    }
    ...
    $.ajax({
        url: BaseURL + "Daerah/UpdateRankhirRKPD",
        type: "POST",
        data: data,
        dataType: "json",
        success: function(res) {
            ...
            if (res.status === "success") {
                alert('✓ Data Rankhir RKPD berhasil diperbarui!\n\nNotifikasi akan muncul di menu Rancangan Akhir Renja Perangkat Daerah.');
                $('#ModalEditRankhir').modal('hide');
                location.reload();
            } else {
...
// ================================================================
// TOMBOL HAPUS RANKHIR RKPD
// ================================================================
$(document).off('click', '.BtnHapusRankhir').on('click', '.BtnHapusRankhir', function(e) {
    e.preventDefault();
    ...
    if (!confirm("⚠️ Anda yakin ingin menghapus data Rankhir RKPD berikut?\n\n" + 
                 "Indikator: " + indikator + "\n\n" +
                 "Data yang dihapus tidak dapat dikembalikan!\n" +
                 "Jika ini adalah satu-satunya indikator, header juga akan dihapus.")) {
        return;
    }
    ...
    $.ajax({
        url: BaseURL + "Daerah/HapusRankhirRKPD",
        type: "POST",
        data: {
            id: id,
            header_id: headerId,
        ...
        success: function(res) {
            hideLoading();
            if (res.status === "success") {
                alert('✓ Data Rankhir RKPD berhasil dihapus!');
                location.reload();
            } else {
