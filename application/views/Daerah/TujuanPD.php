        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="data-table-list">
              ...
              <div class="basic-tb-hd">
                <div class="button-icon-btn sm-res-mg-t-30">
                  <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#ModalInputTujuanPD">
                    <i class="notika-icon bi-plus-lg"></i> <b>Tambah Tujuan PD</b>
                  </button>
                </div>
              </div>
              <br>
            ...
            <div class="table-responsive">
              <table id="data-table-tujuan" class="table table-striped">
                <thead>
                  <tr>
                ...
                <tbody>
                            ...
                            <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                              <?php if ($InstansiId == ($row['id_instansi'] ?? null)) { ?>
                                <button
                                  ...
                                  data-id="<?= (int)$row['id'] ?>"
                                  data-sasaranid="<?= isset($row['sasaran_id']) ? (int)$row['sasaran_id'] : 0 ?>"
                  ...
                  <?php } else { ?>
                    <tr>
                      <td colspan="<?= $IsRole4 ? '6' : '5' ?>" class="text-center">Belum ada data Tujuan PD</td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
    ...
    <div class="modal-dialog modal-md" style="position:absolute; left:50%; top:50%; transform:translate(-50%,-50%);">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Tambah Tujuan PD</h4>
        </div>
              ...
              <div class="form-example-wrap" style="padding:5px;">
                ...
                <div class="form-example-int form-horizental">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <div class="nk-int-st">
                          <select class="form-control input-sm" id="SasaranId">
                            <option value="">Pilih Sasaran</option>
                            <?php if (!empty($SasaranRPJMD)) { ?>
                              <?php foreach ($SasaranRPJMD as $s) { ?>
                ...
                <div class="form-example-int form-horizental">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-lg-3">
                        <label class="hrzn-fm"><b>Tujuan PD</b> <span class="text-danger">*</span></label>
                      </div>
                      <div class="col-lg-8">
                        <div class="nk-int-st">
  ...
  <div class="modal fade" id="ModalEditTujuanPD" role="dialog">
    <div class="modal-dialog modal-md" style="position:absolute; left:50%; top:50%; transform:translate(-50%,-50%);">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Tujuan PD</h4>
        </div>
                ...
                <div class="form-example-int form-horizental">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <div class="nk-int-st">
                          <select class="form-control input-sm" id="EditSasaranId">
                            <option value="">Pilih Sasaran</option>
                            <?php if (!empty($SasaranRPJMD)) { ?>
                              <?php foreach ($SasaranRPJMD as $s) { ?>
                                <option value="<?= (int)$s['Id'] ?>"><?= html_escape($s['Sasaran']) ?></option>
...
<script>
  ...
  jQuery(document).ready(function($){
    ...
    if ($('#data-table-tujuan').length > 0) {
      try {
        if ($.fn.DataTable.isDataTable('#data-table-tujuan')) {
          $('#data-table-tujuan').DataTable().destroy();
        }
        $('#data-table-tujuan').DataTable({
          "pageLength": 10,
          "ordering": false,
          "language": {
      ...
      $("#Filter").click(function() {
        ...
        $.ajax({
          ...
          success: function(res) {
            if (res === '1') {
              var redirectUrl = BaseURL + "Instansi/TujuanPD";
    ...
    <?php if ($IsLoggedIn && !$IsRole4 && !empty($KodeWilayah) && !empty($ListInstansi)) { ?>
      ...
      $("#FilterInstansiBtn").click(function() {
        ...
        var url = BaseURL + "Instansi/TujuanPD";
      ...
      $("#ResetFilterBtn").click(function() {
        window.location.href = BaseURL + "Instansi/TujuanPD";
      });
    ...
    $("#BtnSimpan").click(function(){
      ...
      if(!sasaranId){ alert('Sasaran RPJMD harus dipilih!'); return; }
      ...
      $.ajax({
        url: BaseURL + "Instansi/InputTujuanPD",
        type: "POST",
        data: {
    ...
    $(document).on("click", ".BtnEdit", function(){
      ...
      $("#EditSasaranId").val($(this).data('sasaranid'));
    ...
    $("#BtnUpdate").click(function(){
      var id        = $("#EditId").val();
      var sasaranId = $("#EditSasaranId").val();
      ...
      $.ajax({
        url: BaseURL + "Instansi/EditTujuanPD",
        type: "POST",
        data: {
          id: id,
          sasaran_id: sasaranId,
    ...
    $(document).on("click", ".BtnHapus", function(){
      ...
      $.ajax({
        url: BaseURL + "Instansi/HapusTujuanPD",
        type: "POST",
        data: {
          id: id,
          [CSRF_NAME]: CSRF_TOKEN
