    ...
    $(document).ready(function() {
        ...
        $("#btnSimpanTujuan").click(function() {
            ...
            var data = {
                ...
                instansi_id: FILTER_INSTANSI_ID,
        ...
        $("#btnSimpanProgram").click(function() {
            ...
            $('#OutcomeContainer .outcome-group').each(function() {
                var group = $(this);
                ...
                group.find('.indikator-row').each(function() {
                    ...
                    var target2026 = (row.find('[id^="target_2026_"]').val() || row.find('.target-input:eq(0)').val() || '').trim();
                    var target2027 = (row.find('[id^="target_2027_"]').val() || row.find('.target-input:eq(1)').val() || '').trim();
                    var target2028 = (row.find('[id^="target_2028_"]').val() || row.find('.target-input:eq(2)').val() || '').trim();
                    var target2029 = (row.find('[id^="target_2029_"]').val() || row.find('.target-input:eq(3)').val() || '').trim();
                    var target2030 = (row.find('[id^="target_2030_"]').val() || row.find('.target-input:eq(4)').val() || '').trim();
        ...
        $("#btnSimpanKegiatan").click(function() {
            ...
            $('#KegiatanSasaranContainer .outcome-group').each(function() {
                var group = $(this);
                ...
                group.find('.indikator-row').each(function() {
                    ...
                    var target2026 = (row.find('[id^="kegiatan_target_2026_"]').val() || row.find('.target-input:eq(0)').val() || '').trim();
                    var target2027 = (row.find('[id^="kegiatan_target_2027_"]').val() || row.find('.target-input:eq(1)').val() || '').trim();
                    var target2028 = (row.find('[id^="kegiatan_target_2028_"]').val() || row.find('.target-input:eq(2)').val() || '').trim();
                    var target2029 = (row.find('[id^="kegiatan_target_2029_"]').val() || row.find('.target-input:eq(3)').val() || '').trim();
                    var target2030 = (row.find('[id^="kegiatan_target_2030_"]').val() || row.find('.target-input:eq(4)').val() || '').trim();
        ...
        $("#btnSimpanSubKegiatan").click(function() {
            ...
            $('#SubKegiatanSasaranContainer .outcome-group').each(function() {
                var group = $(this);
                ...
                group.find('.indikator-row').each(function() {
                    ...
                    var target2026 = (row.find('[id^="subkegiatan_target_2026_"]').val() || row.find('.target-input:eq(0)').val() || '').trim();
                    var anggaran2026 = (row.find('[id^="subkegiatan_anggaran_2026_"]').val() || row.find('.anggaran-input:eq(0)').val() || '').replace(/[^0-9]/g, '');
                    var target2027 = (row.find('[id^="subkegiatan_target_2027_"]').val() || row.find('.target-input:eq(1)').val() || '').trim();
                    var anggaran2027 = (row.find('[id^="subkegiatan_anggaran_2027_"]').val() || row.find('.anggaran-input:eq(1)').val() || '').replace(/[^0-9]/g, '');
                    var target2028 = (row.find('[id^="subkegiatan_target_2028_"]').val() || row.find('.target-input:eq(2)').val() || '').trim();
                    var anggaran2028 = (row.find('[id^="subkegiatan_anggaran_2028_"]').val() || row.find('.anggaran-input:eq(2)').val() || '').replace(/[^0-9]/g, '');
                    var target2029 = (row.find('[id^="subkegiatan_target_2029_"]').val() || row.find('.target-input:eq(3)').val() || '').trim();
                    var anggaran2029 = (row.find('[id^="subkegiatan_anggaran_2029_"]').val() || row.find('.anggaran-input:eq(3)').val() || '').replace(/[^0-9]/g, '');
                    var target2030 = (row.find('[id^="subkegiatan_target_2030_"]').val() || row.find('.target-input:eq(4)').val() || '').trim();
                    var anggaran2030 = (row.find('[id^="subkegiatan_anggaran_2030_"]').val() || row.find('.anggaran-input:eq(4)').val() || '').replace(/[^0-9]/g, '');
