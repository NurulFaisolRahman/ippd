...
$(document).ready(function() {
  ...
  function loadDinasOptions(selectedDinasId = '') {
    $.ajax({
      url: BaseURL + 'Daerah/Intermediate_outcome_pd_get_daftar_dinas',
      type: 'GET',
      dataType: 'json',
      beforeSend: function() {
  ...
  function loadPelaksanaByDinas(dinasId, selectedPelaksanaId = '') {
    ...
    $.ajax({
      url: BaseURL + 'Daerah/Intermediate_outcome_pd_get_pelaksana_by_dinas',
      type: 'POST',
  ...
  $(document).on('click', '.btn-edit', function() {
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        if (data.pelaksana) {
          $.ajax({
            url: BaseURL + 'Daerah/Intermediate_outcome_pd_get_pelaksana_detail',
            type: 'POST',
  ...
  $(document).on('click', '.btn-detail', function() {
    ...
    $.post(BaseURL + 'Daerah/Intermediate_outcome_pd_get', {id: id}, function(res) {
      ...
      html += '<tr><th>Pelaksana / Urusan</th><td>' + (data.pelaksana || '—') + '</td></tr>';
