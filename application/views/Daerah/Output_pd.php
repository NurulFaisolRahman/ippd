    ...
    <div class="container-fluid">
      ...
      <div style="background: white; padding: 12px 20px; margin-bottom: 25px; border: 1px solid #dee2e6; border-radius: 5px;">
        <div style="display: flex; gap: 25px; flex-wrap: wrap;">
          ...
          <a href="<?=base_url('Daerah/Output_pd')?>" class="nav-link active">OUTPUT PD (Level 4)</a>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select id="ImmediateId" class="form-control">
...
<!-- MODAL DETAIL (optional - bisa dihapus jika tidak diperlukan) -->
<div class="modal fade" id="ModalDetail" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-info text-white">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h4 class="modal-title">Detail Output PD</h4>
      </div>
...
$(document).ready(function() {
  ...
  function loadDinasOptions(selectedDinasId = '') {
    $.ajax({
      url: BaseURL + 'Daerah/Output_pd_get_daftar_dinas',
      type: 'GET',
      dataType: 'json',
      beforeSend: function() {
  ...
  function loadPelaksanaByDinas(dinasId, selectedPelaksanaId = '') {
    ...
    $.ajax({
      url: BaseURL + 'Daerah/Output_pd_get_pelaksana_by_dinas',
      type: 'POST',
  ...
  function loadPerangkatDaerah(callback) {
    ...
    $.ajax({
      url: BaseURL + "Daerah/Output_pd_get_perangkat_daerah",
      type: "GET",
      dataType: "json",
  ...
  $(document).on('click', '.btn-edit', function() {
    ...
    $('#ModalLevel4 .modal-content').append('<div class="modal-loading"><i class="fa fa-spinner fa-spin fa-3x text-primary"></i><br><span class="mt-2">Memuat data...</span></div>');
    
    $.ajax({
      url: BaseURL + 'Daerah/Output_pd_get',
      type: 'POST',
      data: { id: id },
      dataType: 'json',
      success: function(res) {
        ...
        // Fill basic fields
        $('#ItemId').val(data.id);
        $('#ImmediateId').val(data.immediate_outcome_id || '');
        ...
        if (data.pelaksana) {
          $.ajax({
            url: BaseURL + 'Daerah/Output_pd_get_pelaksana_detail',
            type: 'POST',
  ...
  $('#BtnSimpan').click(function() {
    ...
    $.ajax({
      url: BaseURL + 'Daerah/Output_pd_simpan',
      type: 'POST',
      data: {
        id: id,
  ...
  $(document).on('click', '.btn-hapus', function() {
    ...
    $.post(BaseURL + 'Daerah/Output_pd_hapus', {id: id}, function(res) {
      if (res.status === 'success') {
        alert(res.message);
        location.reload();
      } else {
