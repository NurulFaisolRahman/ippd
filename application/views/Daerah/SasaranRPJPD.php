                    ...
                    <div class="data-table-list">
                        ...
                        <div class="basic-tb-hd">
                            <div class="button-icon-btn sm-res-mg-t-30">
                                ...
                                <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#ModalInputSasaran"><i class="notika-icon bi-plus-lg"></i> <b>Tambah Sasaran RPJPD</b></button>
                             <?php } ?>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                                                <button class="btn btn-sm btn-amber amber-icon-notika btn-reco-mg btn-button-mg Edit" Edit="<?=$key['Id'].'|'.$key['_Id'].'|'.$key['Sasaran'].'|'.$key['Id_'].'|'.$key['Id_']?>"><i class="notika-icon notika-edit"></i></button>
        ...
        <?php if (!isset($_SESSION['KodeWilayah'])) { ?>
            ...
            $("#Filter").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(Respon) {
                        if (Respon === '1') {
                            window.location.href = BaseURL + "Daerah/SasaranRPJPD" ;
                        } else {
        ...
        <?php } ?>
            ...
            $("#Periode").change(function(){
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/GetTujuanRPJPD", {Id : $("#Periode").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Tujuan = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#_Periode").change(function(){
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/GetTujuanRPJPD", {Id : $("#_Periode").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Tujuan = ''
                        for (let i = 0; i < Data.length; i++) {
                            Tujuan += '<option value="'+Data[i].Id+'">'+Data[i].Tujuan+'</option>'
            ...
            $("#PeriodeRPJPN").change(function(){
                if ($("#PeriodeRPJPN").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/GetSasaranRPJPN", {Id : $("#PeriodeRPJPN").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Sasaran = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJPN_").change(function(){
                if ($("#PeriodeRPJPN_").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/GetSasaranRPJPN", {Id : $("#PeriodeRPJPN_").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Sasaran = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJPDP").change(function(){
                if ($("#PeriodeRPJPDP").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/GetSasaranRPJPDP", {Id : $("#PeriodeRPJPDP").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Sasaran = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJPDP_").change(function(){
                if ($("#PeriodeRPJPDP_").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/GetSasaranRPJPDP", {Id : $("#PeriodeRPJPDP_").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Sasaran = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#Input").click(function() {
                ...
                if ($("#Periode").val() == "") {
                    ...
                    var Sasaran = { _Id    : $("#IdTujuan").val(),
                                 ...
                                 Id_    : RPJPDP.join("$"),
                                 Sasaran   : $("#Sasaran").val() }
                    $.post(BaseURL+"Daerah/InputSasaranRPJPD", Sasaran).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Daerah/SasaranRPJPD"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $(document).on("click",".Edit",function(){
                ...
                $("#Id").val(Pisah[0])
                $.post(BaseURL+"Daerah/GetPeriodeSasaranRPJPD", {Id : Pisah[1]}).done(function(Respon) {
                    var Data = JSON.parse(Respon)
            ...
            $("#Edit").click(function() {
                ...
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"Daerah/EditSasaranRPJPD", Sasaran).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Daerah/SasaranRPJPD"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Daerah/HapusSasaranRPJPD", Sasaran).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Daerah/SasaranRPJPD"
                    } else {
                        alert(Respon)
