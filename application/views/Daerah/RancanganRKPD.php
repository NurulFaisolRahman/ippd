...
<head>
    ...
    <style>
        ...
        .lokasi-container #EditLokasiPlaceholder {
            font-size: 12px;
            color: #999;
            padding: 3px 0;
        }
        
        .lokasi-container #EditSelectedLokasiText {
            font-size: 12px;
            color: #2c3e50;
            font-weight: 500;
            white-space: normal;
        ...
        .lokasi-container #EditRemoveLokasiBtn {
            cursor: pointer;
            color: #e74c3c;
            font-size: 16px;
            font-weight: bold;
        ...
        .lokasi-container #EditRemoveLokasiBtn:hover {
            color: #c0392b;
            transform: scale(1.2);
        }
        ...
        #ModalEditRancanganRKPD .modal-body {
            max-height: 70vh;
            overflow-y: auto;
            padding: 15px 20px;
        }
                ...
                <div class="col-lg-12">
                    <div class="data-table-list">
                        ...
                        <div class="basic-tb-hd">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2><i class="fa fa-file-text"></i> Rancangan RKPD</h2>
                                    <p class="text-muted">
                                        <i class="fa fa-info-circle"></i> 
                                        Data diambil dari menu Rancangan Renja Perangkat Daerah. 
                                    </p>
                                </div>
                            </div>
                            <hr>
                                                                        ...
                                                                        <tr class="row-indikator-detail <?= $is_edited ? 'edited-by-daerah' : '' ?>" 
                                                                            ...
                                                                            <td class="text-center" style="white-space: nowrap; min-width: 70px;">
                                                                                <div class="btn-group-aksi">
                                                                                    <button class="btn btn-warning btn-xs BtnEditRancanganRKPD"
                                                                                        data-id="<?= $detail['id'] ?>"
                                                                                        data-header-id="<?= $row['id'] ?>"
                                                                                        title="Edit Data"
                                                                                        type="button">
                                                                                    ...
                                                                                    <button class="btn btn-danger btn-xs BtnHapusRancanganRKPD"
                                                                                        data-id="<?= $detail['id'] ?>"
                                    ...
                                    <?php } else { ?>
                                        <tr>
                                            <td colspan="6" class="text-center no-data">
                                                ...
                                                <strong>Belum ada data Rancangan Renja yang diinput oleh Instansi</strong>
                                                <br>
                                                <small class="text-muted">
                                                    Data akan otomatis muncul saat Instansi membuat Rancangan Renja.
                                                </small>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
<!-- ============================================================ -->
<!-- MODAL EDIT RANCANGAN RKPD (DAERAH)                            -->
<!-- ============================================================ -->
<div class="modal fade" id="ModalEditRancanganRKPD" role="dialog" style="z-index: 999999 !important;">
    <div class="modal-dialog modal-lg" style="position: relative; margin: 30px auto !important; max-width: 900px;">
        <div class="modal-content" style="max-height: 100vh; overflow: hidden; border-radius: 8px; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
            <div class="modal-header" style="flex-shrink: 0; background: #f8f9fa; border-bottom: 2px solid #dee2e6; border-radius: 8px 8px 0 0;">
                ...
                <h4><b><i class="fa fa-edit" style="color: #ffc107;"></i> Edit Rancangan RKPD</b></h4>
                ...
                <div class="alert alert-warning" style="margin-top: 10px; padding: 8px 12px; font-size: 12px;">
                    <i class="fa fa-info-circle"></i> 
                    Perubahan akan ditandai dan muncul di menu <strong>Rancangan Renja Perangkat Daerah</strong> sebagai notifikasi.
                </div>
            </div>
            ...
            <div class="modal-footer" style="flex-shrink: 0; border-top: 1px solid #e5e5e5; padding: 10px 20px; background: #fafafa; border-radius: 0 0 8px 8px;">
                ...
                <button class="btn btn-warning" id="BtnSimpanEditRancangan"><b><i class="fa fa-save"></i> SIMPAN PERUBAHAN</b></button>
            </div>
        </div>
    </div>
</div>
...
var IS_LOGGED_IN = '<?= $IsLoggedIn ?? false ?>';
var IS_ROLE_4 = '<?= $IsRole4 ?? false ?>';
    ...
    $("#Filter").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res === '1' || res === 1) {
                    var redirectUrl = BaseURL + "Daerah/RancanganRKPD";
...
<?php if (isset($_SESSION['KodeWilayah']) && !$is_role_4 && !empty($ListInstansi)) { ?>
    $("#FilterInstansiBtn").click(function() {
        ...
        var url = BaseURL + "Daerah/RancanganRKPD";
        if (instansiId && instansiId != '') { url += "?instansi_id=" + instansiId; }
        window.location.href = url;
    });
    $("#ResetFilterBtn").click(function() { 
        window.location.href = BaseURL + "Daerah/RancanganRKPD"; 
    });
<?php } ?>
...
function initEditSelect2(selector, placeholder = 'Pilih...') {
    ...
    $(selector).select2({
        ...
        dropdownParent: $('#ModalEditRancanganRKPD'),
        width: '100%',
        allowClear: true
    });
}
...
// ================================================================
// TOMBOL EDIT RANCANGAN RKPD
// ================================================================
$(document).off('click', '.BtnEditRancanganRKPD').on('click', '.BtnEditRancanganRKPD', function(e) {
    e.preventDefault();
    var id = $(this).data('id');
    ...
    $.ajax({
        url: BaseURL + "Daerah/GetRancanganRKPDDetail",
        type: "POST",
        data: {
            id: id,
            [CSRF_NAME]: CSRF_TOKEN
        ...
        success: function(res) {
            ...
            if (res.status === "success" && res.data) {
                ...
                // ============================================================
                // LOAD DROPDOWN BIDANG PENGAMPU & PENGAMPU (CASCADING)
                // ============================================================
                ...
                $('#ModalEditRancanganRKPD').modal('show');
            } else {
...
// ================================================================
// TOMBOL SIMPAN EDIT RANCANGAN RKPD
// ================================================================
$(document).off('click', '#BtnSimpanEditRancangan').on('click', '#BtnSimpanEditRancangan', function(e) {
    e.preventDefault();
    ...
    if (!confirm("Anda akan mengubah data Rancangan RKPD.\n\nPerubahan akan ditandai dan muncul sebagai notifikasi di menu Rancangan Renja Perangkat Daerah.\n\nLanjutkan?")) {
        return;
    }
    ...
    var data = {
        ...
        pengampu: pengampu,
        daerah_edit_fields: 'all',
        [CSRF_NAME]: CSRF_TOKEN
    };
    
    $.ajax({
        url: BaseURL + "Daerah/EditRancanganRKPD",
        type: "POST",
        data: data,
        dataType: "json",
        success: function(res) {
            ...
            if (res.status === "success") {
                alert('✓ Data Rancangan RKPD berhasil diperbarui!\n\nNotifikasi akan muncul di menu Rancangan Renja Perangkat Daerah.');
                $('#ModalEditRancanganRKPD').modal('hide');
                location.reload();
            } else {
...
// MODAL SHOWN EVENTS
// ================================================================
$('#ModalEditRancanganRKPD').on('shown.bs.modal', function() {
...
$('#ModalEditRancanganRKPD').on('hidden.bs.modal', function() {
    if ($('#EditBidangPengampu').hasClass('select2-hidden-accessible')) {
        $('#EditBidangPengampu').select2('destroy');
    }
    if ($('#EditPengampu').hasClass('select2-hidden-accessible')) {
...
// ================================================================
// TOMBOL HAPUS RANCANGAN RKPD
// ================================================================
$(document).off('click', '.BtnHapusRancanganRKPD').on('click', '.BtnHapusRancanganRKPD', function(e) {
    e.preventDefault();
    ...
    if (!confirm("⚠️ Anda yakin ingin menghapus data berikut?\n\n" + 
                 "Indikator: " + indikator + "\n\n" +
    ...
    $.ajax({
        url: BaseURL + "Daerah/HapusRancanganRKPD",
        type: "POST",
        data: {
            id: id,
            [CSRF_NAME]: CSRF_TOKEN
