                  ...
                  <?php if (!empty($PermasalahanPD)) { ?>
                    <?php $no=1; foreach ($PermasalahanPD as $row) { ?>
                      <tr>
                        ...
                        <td style="vertical-align: middle;"><?= htmlspecialchars($row['masalah_pokok'], ENT_QUOTES, 'UTF-8') ?></td>
                ...
                <div class="form-example-int form-horizental">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <div class="nk-int-st">
                          <textarea class="form-control input-sm" id="MasalahPokok" rows="3" placeholder="Tulis masalah pokok..."></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-example-int form-horizental">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <div class="nk-int-st">
                          <textarea class="form-control input-sm" id="EditMasalahPokok" rows="3"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  jQuery(document).ready(function($){
    ...
    $("#BtnSimpan").click(function(){
      ...
      $.post(BaseURL + "Daerah/InputPermasalahanPD", {
        masalah: masalah,
        masalah_pokok: $("#MasalahPokok").val().trim(),
