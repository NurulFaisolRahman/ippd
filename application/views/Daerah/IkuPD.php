...
jQuery(document).ready(function($){
  ...
  if ($('#data-table-iku').length > 0) {
    try {
      if ($.fn.DataTable.isDataTable('#data-table-iku')) {
        $('#data-table-iku').DataTable().destroy();
      }
      $('#data-table-iku').DataTable({
        "pageLength": 10,
        "ordering": false,
        "language": {
  ...
  $("#Provinsi").change(function() {
    ...
    $.ajax({
      ...
      error: function() { alert("Gagal memuat Kab/Kota"); }
    });
  });
  ...
  $("#KabKota").change(function() {
    ...
    $.ajax({
      ...
      error: function() { alert("Gagal memuat Instansi"); }
    });
  });
