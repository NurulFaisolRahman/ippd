                ...
                <div class="breadcomb-list">
                    <ul class="breadcomb-menu" style="list-style: none; padding: 0; margin: 0;">
                        <li style="display: inline-block; margin-right: 5px;">
                            <a href="<?= base_url('Kementerian') ?>">Beranda</a>
                            <span class="bread-slash" style="display: inline-block; margin: 0 5px;">/</span>
                        </li>
                        <li style="display: inline-block; margin-right: 5px;">
                            <a href="<?= base_url('Kementerian/Isu') ?>">Isu</a>
                            <span class="bread-slash" style="display: inline-block; margin: 0 5px;">/</span>
                        </li>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#ApplyFilter").click(function() {
            ...
            var url = BaseURL + "Kementerian/IsuGlobal?";
        ...
        $("#InputIsuGlobal").click(function() {
            if ($("#InputPeriode").val() === "") {
                ...
                $.post(BaseURL + "Kementerian/InputIsuGlobal", Data).done(function(Respon) {
                    if (Respon == '1') {
        ...
        $("#UpdateIsuGlobal").click(function() {
            if ($("#EditPeriode").val() === "") {
                ...
                $.post(BaseURL + "Kementerian/UpdateIsuGlobal", Data).done(function(Respon) {
                    if (Respon == '1') {
                        window.location.reload();
                    } else {
                        alert(Respon);
        ...
        $(document).on("click", ".Hapus", function() {
            if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
                ...
                $.post(BaseURL + "Kementerian/DeleteIsuGlobal", Id).done(function(Respon) {
                    if (Respon == '1') {
                        window.location.reload();
                    } else {
                        alert(Respon);
