                        ...
                        <table class="table table-striped table-bordered table-hover" id="tabelPendanaan" style="min-width: 2800px; font-size: 12px;">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="5" class="text-center" style="background-color: #00c292 !important; color: white;">APBN (Miliar Rp)</th>
                                    <th colspan="5" class="text-center" style="background-color: #00c292 !important; color: white;">Non-APBN (Miliar Rp)</th>
                                    <th colspan="5" class="text-center" style="background-color: #00c292 !important; color: white;">Total (Miliar Rp)</th>
    ...
    <div class="modal-dialog modal-lg" style="width: 600px;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 30px;">
                ...
                <p class="detail-satuan" style="color: #999; font-size: 13px; margin-top: 15px;">* Nilai dalam Miliar Rupiah</p>
            </div>
                        ...
                        <table class="table table-bordered">
                            <thead style="background-color: #f5f5f5;">
                                <tr>
                                    ...
                                    <th class="text-center">APBN (Miliar Rp)</th>
                                    <th class="text-center">Non-APBN (Miliar Rp)</th>
                                    <th class="text-center">Total (Miliar Rp)</th>
                                </tr>
                            </thead>
                            <tbody>
...
<!-- JavaScript (hanya ubah format tampilan, sisanya sama seperti kode awal) -->
<script>
var BaseURL = '<?= base_url() ?>';
if (BaseURL.slice(-1) !== '/') BaseURL += '/';

// Format nilai dalam Miliar Rupiah (10,39 atau 1.250,75)
function formatMilyar(nilai) {
...
// Format penuh untuk modal
function formatPenuh(nilai) {
    nilai = parseFloat(nilai) || 0;
    return 'Rp ' + nilai.toLocaleString('id-ID', { minimumFractionDigits: 2 }) + ' Miliar';
}

// Terapkan format Miliar ke semua sel tabel
$(document).ready(function() {
    $('.nilai-detail').each(function() {
        let full = $(this).data('full');
        $(this).html(formatMilyar(full));
    });
});
...
// Hitung total di modal (tetap sama)
...
// === Bagian AJAX tetap persis seperti kode awal Anda ===
