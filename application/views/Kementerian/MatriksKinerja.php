                        ...
                        <table class="table table-striped table-bordered table-hover" id="tabelMatriks" style="min-width: 3200px; font-size: 12px;">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="5" class="text-center" style="background-color: #00b686; color: white;">APBN (Miliar Rp)</th>
                                    <th colspan="5" class="text-center" style="background-color: #00b686; color: white;">Non-APBN (Miliar Rp)</th>
                                    <th colspan="5" class="text-center" style="background-color: #00b686; color: white;">Total (Miliar Rp)</th>
...
$(document).ready(function() {
    ...
    // Format penuh untuk modal detail
    function formatPenuh(nilai) {
        nilai = parseFloat(nilai) || 0;
        return 'Rp ' + nilai.toLocaleString('id-ID', { minimumFractionDigits: 2 }) + ' Miliar';
    }

    // Terapkan format Miliar ke semua sel .nilai-detail
    $('.nilai-detail').each(function() {
        $(this).text(formatMilyar($(this).data('full')));
    });

    // Klik sel nilai untuk melihat detail
    ...
    // === Bagian JavaScript CRUD lainnya tetap sama seperti kode awal Anda ===
