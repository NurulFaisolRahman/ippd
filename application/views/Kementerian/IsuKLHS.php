...
$(document).ready(function () {
    ...
    $('#InputIsuKLHS').on('click', function () {
        ...
        if (nama.length < 5) {
            alert('Nama Isu KLHS minimal 5 karakter');
            return;
        }
...
$(document).on('click', '.Edit', function (e) {
    ...
    $.ajax({
        url: BaseURL + 'Kementerian/GetIsuKLHSById',
        type: 'POST',
        dataType: 'json',
        data: { Id: id },
        success: function (response) {
            ...
            if (response.success) {
                ...
                $('#EditNamaIsuKLHS').val(response.data.NamaIsuKLHS);
 ...
 * ===================================================== */
$(document).on('click', '#UpdateIsuKLHS', function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url: BaseURL + 'Kementerian/UpdateIsuKLHS',
        type: 'POST',
        dataType: 'json',
        data: { 
            Id: id,
