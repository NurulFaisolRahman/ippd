                                    ...
                                    <td>
                                        <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                                            <button class="btn btn-sm btn-amber amber-icon-notika btn-reco-mg btn-button-mg Edit" 
                                                data-edit="<?= $key['Id'] . '|' . $key['IdKementerian'] . '|' . $key['NamaPermasalahanPokok'] . '|' . $key['TahunMulai'] . '|' . $key['TahunAkhir'] ?>">
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" id="NamaPermasalahanPokok" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" id="EditNamaPermasalahanPokok" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Show filter modal
        $("#FilterPermasalahanPokok").click(function() {
        ...
        $(document).on("click", ".Edit", function() {
            ...
            $("#EditId").val(Data[0]);
            $("#EditNamaPermasalahanPokok").val(Data[2]);
