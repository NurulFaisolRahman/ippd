        ...
        jQuery(document).ready(function($) {
            ...
            $("#Periode").change(function(){
                if ($("#Periode").val() == "") {
                    ...
                    $.post(BaseURL+"SuperDaerah/GetMisiRPJPD", {Id : $("#Periode").val()}).done(function(Respon) {
            ...
            $("#_Periode").change(function(){
                if ($("#_Periode").val() == "") {
                    ...
                    $.post(BaseURL+"SuperDaerah/GetMisiRPJPD", {Id : $("#_Periode").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Misi = ''
                        for (let i = 0; i < Data.length; i++) {
                            Misi += '<option value="'+Data[i].Id+'">'+Data[i].Misi+'</option>'
            ...
            $("#PeriodeRPJPN").change(function(){
                if ($("#PeriodeRPJPN").val() == "") {
                    ...
                    $.post(BaseURL+"SuperDaerah/GetTujuanRPJPN", {Id : $("#PeriodeRPJPN").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Tujuan = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJPN_").change(function(){
                if ($("#PeriodeRPJPN_").val() == "") {
                    ...
                    $.post(BaseURL+"SuperDaerah/GetTujuanRPJPN", {Id : $("#PeriodeRPJPN_").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Tujuan = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJPDP").change(function(){
                if ($("#PeriodeRPJPDP").val() == "") {
                    ...
                    $.post(BaseURL+"SuperDaerah/GetTujuanRPJPDP", {Id : $("#PeriodeRPJPDP").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Tujuan = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJPDP_").change(function(){
                if ($("#PeriodeRPJPDP_").val() == "") {
                    ...
                    $.post(BaseURL+"SuperDaerah/GetTujuanRPJPDP", {Id : $("#PeriodeRPJPDP_").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Tujuan = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#Input").click(function() {
                ...
                if ($("#Periode").val() == "") {
                    ...
                    var Tujuan = { _Id    : $("#IdMisi").val(),
                                 ...
                                 IdP    : RPJPDP.join("$"),
                                 Tujuan   : $("#Tujuan").val() }
                    $.post(BaseURL+"SuperDaerah/InputTujuanRPJPD", Tujuan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"SuperDaerah/TujuanRPJPD"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $(document).on("click",".Edit",function(){
                ...
                $("#Id").val(Pisah[0])
                $.post(BaseURL+"SuperDaerah/GetPeriodeTujuanRPJPD", {Id : Pisah[1]}).done(function(Respon) {
                    var Data = JSON.parse(Respon)
            ...
            $("#Edit").click(function() {
                ...
                if ($("#_Periode").val() == "") {
                    ...
                    var Tujuan = { Id     : $("#Id").val(),
                                 ...
                                 IdP    : RPJPDP.join("$"),
                                 Tujuan   : $("#_Tujuan").val() }
                    $.post(BaseURL+"SuperDaerah/EditTujuanRPJPD", Tujuan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"SuperDaerah/TujuanRPJPD"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"SuperDaerah/HapusTujuanRPJPD", Tujuan).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"SuperDaerah/TujuanRPJPD"
                    } else {
                        alert(Respon)
