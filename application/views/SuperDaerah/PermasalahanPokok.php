...
<script>
    ...
    $("#PeriodePermasalahanPokokNasional").change(function(){
        if ($(this).val() == "") {
            ...
            $.post(BaseURL+"SuperDaerah/GetKementerian", {TahunMulai: $(this).val()}).done(function(Respon) {
    ...
    $("#Kementerian").change(function(){
        if ($(this).val() == "") {
            ...
            $.post(BaseURL+"SuperDaerah/GetPermasalahanPokokNasional", {Id: $(this).val()}).done(function(Respon) {
                var Data = JSON.parse(Respon);
                var Permasalahan = '';
                for (let i = 0; i < Data.length; i++) {
    ...
    $("#InputPermasalahanPokok").click(function() {
        ...
        $.post(BaseURL + "SuperDaerah/InputPermasalahanPokok", Data).done(function(Respon) {
            if (Respon == '1') {
                // Reset form input
    ...
    $(document).on("click", ".EditPermasalahan", function() {
        ...
        $.post(BaseURL + "SuperDaerah/GetPeriodePermasalahanPokokNasional", {Id: kementerian}).done(function(Respon) {
    ...
    $("#UpdatePermasalahanPokok").click(function() {
        ...
        $.post(BaseURL + "SuperDaerah/UpdatePermasalahanPokok", Data).done(function(Respon) {
            if (Respon == '1') {
    ...
    $(".HapusPermasalahan").click(function() {
        if(confirm("Apakah Anda yakin ingin menghapus data ini?")) {
            ...
            $.post(BaseURL + "SuperDaerah/DeletePermasalahanPokok", Id).done(function(Respon) {
                if (Respon == '1') {
                    window.location.reload();
                } else {
                    alert(Respon);
