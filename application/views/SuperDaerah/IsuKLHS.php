...
<script>
    ...
    $("#PeriodeIsuKLHSNasional").change(function(){
        if ($("#PeriodeIsuKLHSNasional").val() == "") {
            ...
            $.post(BaseURL+"SuperDaerah/GetKementerianIsu", {TahunMulai : $("#PeriodeIsuKLHSNasional").val()}).done(function(Respon) {
    ...
    $("#Kementerian").change(function(){
        if ($("#Kementerian").val() == "") {
            ...
            $.post(BaseURL+"SuperDaerah/GetIsuKLHSNasional", {Id : $("#Kementerian").val()}).done(function(Respon) {
                var Data = JSON.parse(Respon)
                var Isu = ''
                for (let i = 0; i < Data.length; i++) {
    ...
    $("#EditPeriodeIsuKLHSNasional").change(function(){
        if ($(this).val() == "") {
            ...
            $.post(BaseURL+"SuperDaerah/GetKementerianIsu", {TahunMulai: $(this).val()}).done(function(Respon) {
                var Data = JSON.parse(Respon);
                var Kementerian = '<option value="">-- Pilih Kementerian --</option>';
                for (let i = 0; i < Data.length; i++) {
                    Kementerian += '<option value="'+Data[i].Id+'">'+Data[i].NamaKementerian+'</option>';
    ...
    $("#EditKementerian").change(function(){
        if ($(this).val() == "") {
            ...
            $.post(BaseURL+"SuperDaerah/GetIsuKLHSNasional", {Id: $(this).val()}).done(function(Respon) {
                var Data = JSON.parse(Respon);
                var Isu = '';
                for (let i = 0; i < Data.length; i++) {
    ...
    $("#InputIsuKLHS").click(function() {
        ...
        if ($("#PeriodeRPJMD").val() === "") {
            ...
            $.post(BaseURL + "SuperDaerah/InputIsuKLHS", Data).done(function(Respon) {
                if (Respon == '1') {
                    // Reset form input
    ...
    $(document).on("click", ".Edit", function() {
        ...
        $.post(BaseURL + "SuperDaerah/GetPeriodeIsuKLHSNasional", {Id: kementerian}).done(function(Respon) {
    ...
    $("#UpdateIsuKLHS").click(function() {
        ...
        $.post(BaseURL + "SuperDaerah/UpdateIsuKLHS", Data).done(function(Respon) {
            if (Respon == '1') {
    ...
    $(".Hapus").click(function() {
        if(confirm("Apakah Anda yakin ingin menghapus data ini?")) {
            ...
            $.post(BaseURL + "SuperDaerah/DeleteIsuKLHS", Id).done(function(Respon) {
                if (Respon == '1') {
                    window.location.reload();
                } else {
                    alert(Respon);
