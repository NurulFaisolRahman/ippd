                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                                            <button class="btn btn-sm btn-amber amber-icon-notika btn-reco-mg btn-button-mg Edit" Edit="<?= $key['Id'] . '|' . $key['IdKementerian'] . '|' . $key['NamaIsuKLHS'] . '|' . $key['TahunMulai'] . '|' . $key['TahunAkhir'] ?>"><i class="notika-icon notika-edit"></i></button>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm" id="NamaIsuKLHS">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                ...
                                                <input type="text" class="form-control input-sm" id="EditNamaIsuKLHS">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#InputIsuKLHS").click(function() {
            if ($("#Periode").val() === "") {
                ...
                $.post(BaseURL + "Super/InputIsuKLHS", Data).done(function(Respon) {
                    if (Respon == '1') {
        ...
        $("#UpdateIsuKLHS").click(function() {
            if ($("#EditPeriode").val() === "") {
                ...
                $.post(BaseURL + "Super/UpdateIsuKLHS", Data).done(function(Respon) {
                    if (Respon == '1') {
                        window.location.reload();
                    } else {
                        alert(Respon);
        ...
        $(".Hapus").click(function() {
                ...
                $.post(BaseURL+"Super/DeleteIsuKLHS", Misi).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Super/IsuKLHS"
                    } else {
                        alert(Respon)
                    }
                })                         
