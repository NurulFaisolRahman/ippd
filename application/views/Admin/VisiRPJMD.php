        ...
        jQuery(document).ready(function($) {
            ...
            $("#Input").click(function() {
                if (isNaN($("#TahunMulai").val()) || $("#TahunMulai").val() == "" || $("#TahunMulai").val().length != 4) {
                    ...
                    $.post(BaseURL+"Admin/InputVisiRPJMD", Visi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Admin/VisiRPJMD"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $("#Edit").click(function() {
                if (isNaN($("#_TahunMulai").val()) || $("#_TahunMulai").val() == "" || $("#_TahunMulai").val().length != 4) {
                    ...
                    $.post(BaseURL+"Admin/EditVisiRPJMD", Visi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Admin/VisiRPJMD"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Admin/HapusVisiRPJMD", Visi).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Admin/VisiRPJMD"
                    } else {
                        alert(Respon)
