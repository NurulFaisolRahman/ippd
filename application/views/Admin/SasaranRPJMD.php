        ...
        jQuery(document).ready(function($) {
            ...
            $("#PeriodeRPJMDP").change(function(){
                if ($("#PeriodeRPJMDP").val() == "") {
                    ...
                    $.post(BaseURL+"Admin/GetSasaranRPJMDP", {Id : $("#PeriodeRPJMDP").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Sasaran = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $("#PeriodeRPJMDP_").change(function(){
                if ($("#PeriodeRPJMDP_").val() == "") {
                    ...
                    $.post(BaseURL+"Admin/GetSasaranRPJMDP", {Id : $("#PeriodeRPJMDP_").val()}).done(function(Respon) {
                        var Data = JSON.parse(Respon)
                        var Sasaran = ''
                        for (let i = 0; i < Data.length; i++) {
            ...
            $(document).on("click",".Edit",function(){
                ...
                $("#Id").val(Pisah[0])
                $.post(BaseURL+"Admin/GetPeriodeSasaranRPJMD", {Id : Pisah[1]}).done(function(Respon) {
                    var Data = JSON.parse(Respon)
