                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                                                <button class="btn btn-sm btn-amber amber-icon-notika btn-reco-mg btn-button-mg Edit" Edit="<?=$key['Id'].'|'.$key['Tahapan'].'|'.$key['TahunMulai'].'|'.$key['TahunAkhir']?>"><i class="notika-icon notika-edit"></i></button>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#Input").click(function() {
                if (isNaN($("#TahunMulai").val()) || $("#TahunMulai").val() == "" || $("#TahunMulai").val().length != 4) {
                    ...
                    $.post(BaseURL+"Admin/InputTahapanRPJMD", Tahapan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Admin/TahapanRPJMD"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $("#Edit").click(function() {
                if (isNaN($("#_TahunMulai").val()) || $("#_TahunMulai").val() == "" || $("#_TahunMulai").val().length != 4) {
                    ...
                    $.post(BaseURL+"Admin/EditTahapanRPJMD", Tahapan).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Admin/TahapanRPJMD"
                        } else {
                            alert(Respon)
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Admin/HapusTahapanRPJMD", Tahapan).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Admin/TahapanRPJMD"
                    } else {
                        alert(Respon)
