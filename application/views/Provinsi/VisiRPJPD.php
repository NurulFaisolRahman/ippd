                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                                                <button class="btn btn-sm btn-amber amber-icon-notika btn-reco-mg btn-button-mg Edit" Edit="<?=$key['Id'].'|'.$key['Visi'].'|'.$key['TahunMulai'].'|'.$key['TahunAkhir'].'|'.$key['KodeWilayah']?>"><i class="notika-icon notika-edit"></i></button>
                            ...
                            <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="nk-int-st">
                                                <textarea class="form-control" rows="3" id="_Visi" placeholder="Input Visi RPJPD"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#Input").click(function() {
                if ($("#Provinsi").val() == "") {
                    ...
                    $.post(BaseURL+"Super/InputVisiRPJPD", Visi).done(function(Respon) {
                        if (Respon == '1') {
                            window.location = BaseURL+"Super/VisiRPJPD"
                        } else {
                            alert(Respon)
                        }
                    })                         
            ...
            $('#data-table-basic tbody').on('click', '.Hapus', function () {
                ...
                $.post(BaseURL+"Super/HapusVisiRPJPD", Visi).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Super/VisiRPJPD"
                    } else {
                        alert(Respon)
