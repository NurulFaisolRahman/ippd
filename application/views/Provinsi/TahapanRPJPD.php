            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="data-table-list">
                    ...
                    <div class="basic-tb-hd" style="margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                        <h3 style="margin: 0; color: #333; font-weight: 600; line-height: 1.5;">Hierarki Tahapan RPJPD</h3>
                        <div class="button-icon-btn sm-res-mg-t-30">
                            ...
                            <button type="button" class="btn btn-success notika-btn-success btn-action" data-toggle="modal" data-target="#ModalInputTahapan" style="padding: 8px 15px;">
                                <i class="fa fa-plus-circle" style="margin-right: 5px;"></i> <b>Input Tahapan RPJPD</b>
                            </button>
                        </div>
                    </div>
                        ...
                        <table id="hierarki-table" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center" style="padding: 30px; color: #999;">Belum ada data Tahapan RPJPD.</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="form-group ic-cmp-int">
                            ...
                            <div class="bootstrap-select fm-cmp-mg">
                                <select class="selectpicker form-control" data-live-search="true" id="IdVisi">
                                    <option value="">Pilih Periode RPJPD</option>
                                    <?php 
                                    if(isset($Visi)) {
                                        foreach ($Visi as $cv) {
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="Tahapan" rows="3" style="resize: vertical;" placeholder="Uraian Tahapan RPJPD"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="_Tahapan" rows="3" style="resize: vertical;" placeholder="Uraian Tahapan RPJPD"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="ModalInputSubTahapan" role="dialog">
    <div class="modal-dialog modals-default">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h2>Tambah Sub Tahapan RPJPD</h2>
            </div>
            <div class="modal-body" style="padding-top: 20px;">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="SubTahapan" rows="3" style="resize: vertical;" placeholder="Uraian Sub Tahapan RPJPD"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <textarea class="form-control" id="_SubTahapan" rows="3" style="resize: vertical;" placeholder="Uraian Sub Tahapan RPJPD"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // ==============================================
        // SCRIPT SUB TAHAPAN RPJPD (LEVEL 2)
        // ==============================================
