            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="data-table-list">
                    <div class="basic-tb-hd" style="margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center;">
                        <h3 style="margin: 0; color: #333; font-weight: 600;">Indikator Utama Pembangunan (IUP) RPJMD</h3>
                        <div class="button-icon-btn">
                            <button type="button" class="btn btn-success notika-btn-success btn-action" data-toggle="modal" data-target="#ModalInputIUP" style="padding: 8px 15px;">
                                <i class="fa fa-plus-circle" style="margin-right: 5px;"></i> <b>Input IUP RPJMD</b>
                            </button>
                        </div>
                    </div>
                        ...
                        <table id="data-table-basic" class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 35%;">IUP RPJMD</th>
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <input type="text" class="form-control" id="IUP" placeholder="Uraian IUP RPJMD">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group ic-cmp-int float-lb floating-lb">
                            ...
                            <div class="nk-int-st">
                                <input type="text" class="form-control" id="_IUP" placeholder="Uraian IUP RPJMD">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#SimpanIUP").click(function() {
            if ($("#IdVisi").val() == "") {
                alert("Mohon Pilih Periode RPJMD")
            } else if ($("#IUP").val() == "") {
                ...
                $.post(BaseURL+"Nasional/InputIUPRPJMD", IUP).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Nasional/IUPRPJMD"
                    } else {
                        alert(Respon)
                    }
                })                         
        ...
        $("#Edit").click(function() {
            if ($("#_IUP").val() == "") {
                ...
                $.post(BaseURL+"Nasional/EditIUPRPJMD", IUP).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Nasional/IUPRPJMD"
                    } else {
                        alert(Respon)
        ...
        $('#data-table-basic tbody').on('click', '.Hapus', function () {
            if(confirm("Apakah Anda yakin ingin menghapus data IUP ini?")) {
                ...
                $.post(BaseURL+"Nasional/HapusIUPRPJMD", IUP).done(function(Respon) {
                    if (Respon == '1') {
                        window.location = BaseURL+"Nasional/IUPRPJMD"
                    } else {
                        alert(Respon)
